...
It is simple, fast and all in one file; and if your code is that sleek, who cares about safety?

The reason it's so incredibly unsafe is because of my irrational fear of libraries, so I ended up
writing my own 100% certified unsafe encryption/decryption tool.
